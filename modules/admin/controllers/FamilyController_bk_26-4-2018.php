                ...
                for($i=1;$i<8;$i++){
                    if(isset($_POST['DayMaster']['id'][$i])){
                        ...
                        if(count($time_model)>0){
                            ...
                            $time_model->end_time=($time_model->all_day==1)?'23:59':date('H:i',strtotime($_POST['DayMaster']['end_time'][$i]));
                            $time_model->status=1;
                            ...
                            $new_time_model->end_time=($new_time_model->all_day==1)?'23:59':date('H:i',strtotime($_POST['DayMaster']['end_time'][$i]));

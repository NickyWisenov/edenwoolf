        ...
        <div class="portlet light bordered">
            <div class="portlet-title">
                ...
                <div class="pull-right">
                    <!--<a class="btn btn-success" href="<?php // Url::to(['carer/create']); ?>"><i class="fa fa-plus" aria-hidden="true"></i> Create Carer</a>&nbsp;-->
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header" style="background-color: #17C4BB;">
                ...
                <h4 class="modal-title" style="color: white;">Delete Carer</h4>
            </div>
            <div class="modal-body">
                <h4>Do you want to delete this carer?</h4>
            </div>

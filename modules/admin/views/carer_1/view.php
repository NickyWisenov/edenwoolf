...
$this->title = 'View Carer: ' . ((isset($model->first_name) && $model->first_name != null) ? ucfirst(strtolower($model->first_name)) : "Not Given") . ' ' . ((isset($model->last_name) && $model->last_name != null) ? ucfirst(strtolower($model->last_name)) : "");
    ...
    <div class="portlet-body form">
        <form class="form-horizontal">
            ...
            <div class="form-actions text-right">
                <a href="<?= Url::to(['carer/update', 'id' => $model->id]); ?>" class="btn green">
                    <i class="fa fa-pencil"></i> Edit
                </a>
                <a href="<?= Url::to(['carer/']); ?>" class="btn default">Back</a>
            </div>
        </form>
    </div>
</div>
        ...
        <div class="portlet light bordered">
            <div class="portlet-title">
                ...
                <div class="pull-right">
                    <!--<a class="btn btn-success" href="<?php //  Url::to(['family/create']); ?>"><i class="fa fa-plus" aria-hidden="true"></i> Create Family</a>&nbsp;-->
                    <a class="btn btn-info" href="javascript:;" onclick="$('#search_filter').toggle();"><i class="fa fa-search" aria-hidden="true"></i> Filter</a>&nbsp;
                    <a class="btn btn-info" href="<?= Url::to(['family/index']); ?>"><i class="glyphicon glyphicon-repeat"></i></i> Reset</a>
                </div>
            </div>
                                ...
                                foreach ($model as $key => $val) {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="javascript:;" onclick="deleteFamily(this);" data-id="<?= $val->id; ?>" style="text-decoration: none;" title="Delete">
...
<div class="modal fade" tabindex="-1" role="dialog" id="deletefamilyModal">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header" style="background-color: #17C4BB;">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title" style="color: white;">Delete Family</h4>
            </div>
            <div class="modal-body">
                <h4>Do you want to delete this family?</h4>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal">No</button>
                <a id="deletefamilyButton" class="btn btn-success" style="background-color: #17C4BB;">Yes</a>
            </div>
        </div><!-- /.modal-content -->
    </div><!-- /.modal-dialog -->
</div>
...
<script>
    function deleteFamily(obj) {
        ...
        var url = full_path + 'family/delete?id=' + id;
        $("#deletefamilyButton").attr("href", url);

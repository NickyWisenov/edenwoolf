...
<div class="col-md-3 col-sm-4 padding-lt-rt">
    <div class="left-part">
        <div class="top-part">
            <div class="media">
                ...
                <div class="media-body">
                    <h1>Welcome</h1>
                    <h2 class="color-imp-cls">Happy Client</h2>
        ...
        <div class="bottom-part">
            <ul>
                <li><a href="<?= Url::toRoute(['family/dashboard']); ?>"><i class="fa fa-home" aria-hidden="true"></i> Dashboard</a></li>
                <li><a href="<?= Url::toRoute(['family/editprofile']); ?>"><i class="fa fa-user" aria-hidden="true"></i>Edit profile</a></li> 
                ...
                <li><a href="javascript:;"><i class="fa fa-star-o" aria-hidden="true"></i>Favourite carers</a></li>

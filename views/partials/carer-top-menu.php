...
<div class="top-part">
    <div class="clearfix">
        ...
        <div class="col-sm-3 col-xs-6 padding-lft-10">
            <div class="top-part-box">
                <a href="<?= Url::toRoute(['carer/editprofile']); ?>">
                ...
                <h1>
                    <a href="<?= Url::toRoute(['carer/editprofile']); ?>">Profile</a> 
                </h1>
            </div>
        </div>
        ...
        <div class="col-sm-3 col-xs-6 padding-lft-10">
            <div class="top-part-box">
                <a href="<?= Url::toRoute(['carer/dashboard']); ?>">
                ...
                <h1>
                    <a href="<?= Url::toRoute(['carer/dashboard']); ?>">Jobs</a> 
                </h1>
            </div>
        </div>

                    ...
                    <div class="col-md-9 col-sm-9">
                        <div class="blog-list-box-right">
                            ...
                            <div class="text-center row">
                                <div class="col-sm-6 tab-btn">
<!--                                    <a class="btn" href="<?php echo Yii::$app->urlManager->createAbsoluteUrl(["search/familyprofile", "user_id" => base64_encode($val->fav_id)]) ?>">View profile</a>-->
                                    <!--<a class="btn" href="javascript:;">View profile</a>-->

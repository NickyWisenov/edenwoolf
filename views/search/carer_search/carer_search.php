                ...
                <div class="panel-body-main">
                    ...
                    <div class="clearfix">
                        <div class="col-md-3 col-sm-4">
                            <div class="left-part">
                                <?= Yii::$app->controller->renderPartial('carer_search/carer_search_left.php', ['searchPostData' => $searchPostData,'limit' => $limit, 'offset' => $offset]); ?>
                            </div>
                        </div>
                                ...
                                <div class="bottom-part">
                                    <div class="clearfix">
                                        ...
                                        <div class="text-center row load_more" style="display:none;">
                                                ...
                                                <a class="btn" href="javascript:;" onclick="loadMoreCarer();"><span>Load More <i class="fa fa-long-arrow-down" aria-hidden="true"></i></span></a>

...
<!-- <script type="text/javascript">
    function chat()
    {
        ...
        window.location.href = '/joblog/chatview?userid=' + encodeURIComponent(userId) + '&nickname=' + encodeURIComponent(nickname) + '&cid=' + encodeURIComponent(cid) + '&cname=' + encodeURIComponent(cname);
    						...
    						<div class="btn-rap cmn-grn-new-btn-wrp text-center">
    							<ul>
                                             <!-- <li>
                                                ...
                                                <!--<a href="#" onclick="chat();" class="style-btn blue-btn"><span>Message</span></a>
                                                <?php
                                                }
                                                else
                                                {
...
<!-- <script src="/web/frontend/static/lib/SendBird.min.js"></script> -->
<!-- *****************Join-end****************** -->
<!-- <script src="/web/frontend/widget/SendBird.min.js"></script>
<script src="/web/frontend/widget/build/widget.SendBird.js"></script>
<script>
	var appId = '1188D09F-B3E5-4969-B1DC-6F61314059EA';
	var userId = document.getElementsByName('user_id')[0].value;
	var nickname = document.getElementsByName('user_name')[0].value;
	var userIds = document.getElementsByName('cid')[0].value;
	...
	sbWidget.start('1188D09F-B3E5-4969-B1DC-6F61314059EA');

</script> -->
<script>
	function getfamilyProfile(id){
		ajaxindicatorstart();
		var url = full_path + "search/getfamilyprofileajax";
		$.ajax({
			url: url,
			type: "POST",
			data: {id:id},

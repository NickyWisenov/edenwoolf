...
<!--                    <ul class="bred-cramb">
                        ...
                        <li>
                            <a href="<?= Yii::$app->urlManager->createAbsoluteUrl(["search/carersearch"]) ?>">Carer</a>
                        </li>
                    </ul>-->
<?php
if(isset($session['all_carer']) && $session['all_carer']!=''){
$index=array_search(base64_encode($carerDetails->user_id),$session['all_carer']);
$prev_index=$index-1;
$next_index=$index+1;
$prev_id=isset($session['all_carer'][$prev_index])?$session['all_carer'][$prev_index]:'';
$next_id=isset($session['all_carer'][$next_index])?$session['all_carer'][$next_index]:'';
?>
                            <div class="btn-rap cmn-grn-new-btn-wrp text-center">
                                         <ul class="small-55">
                                            <li>
                                                <a href="javascript:;" onclick='<?= ($prev_id=='')?'javascript:;':'getProfile("'.$prev_id.'")' ?>' class="no-decor homepage-button booking-link prev-next" style="<?=($prev_id=='')?'cursor:no-drop':''?>"><span>Previous</span></a>
                                            </li>
                                            <li>
                                                <a href="javascript:;" onclick='<?= ($next_id=='')?'javascript:;':'getProfile("'.$next_id.'")' ?>' class="style-btn blue-btn prev-next" style="<?=($next_id=='')?'cursor:no-drop':''?>"><span>Next</span></a>
                                            </li>
                                        </ul>
                                    </div>
<?php } ?>
                    ...
                    <div class="left-part">
                        <div class="top-box">
                            <div class="top-part-img">
                                <a href="javascript:;"><img src="<?= $this->context->getOriginalUserProfileImage($carerDetails->user_id) ?>" alt="" class="img-responsive"></a>
                            </div>
                            <div class="bottom-ul">
                                <div class="name-dg-grp">
                                    <div class="heding-1"><?= $carerDetails->user_details->display_name ?>
                                        <span>
                                                     <?php
                        $fav = \app\models\FavouriteMaster::find()->where(['user_id' => Yii::$app->user->id, 'fav_id' => $carerDetails->user_id, 'status' => "1"])->count();
//                        if ($carerDetails->user_id != Yii::$app->user->id && isset(Yii::$app->user->identity->type_id) && Yii::$app->user->identity->type_id != '2') {
                        if ($carerDetails->user_id != Yii::$app->user->id) {
                            ?>
                        <div class="new-text-right-5">
                            <div id="fav_<?=$carerDetails->user_id?>" class="fav-h fav-h-2 <?= (($fav > 0) ? 'active' : ''); ?>">
                                <a href="javascript:;" onclick="<?= (($fav > 0) ? 'removefromFav(this);' : 'addtoFav(this);'); ?>" data-id="<?= $carerDetails->user_id; ?>">
                        ...
                        ?>
                                ...
                                <ul class="nw-list">
                                    <li class="clearfix">
                                        <span class="col-md-6 col-sm-6 col-xs-5 left-span"><i class="fa fa-clock-o" aria-hidden="true"></i>Experience</span>
                                        <span class="col-md-6 col-sm-6 col-xs-7 right-span"><?php
                                            if ($carerDetails->caring_experience == 0) {
                                                echo "Not yet";
                                            } else if ($carerDetails->caring_experience > 4) {
                                                echo "5+ Year(s)";
                                            } else {
                                                echo $carerDetails->caring_experience . " Year(s)";
                                            }
                                            ?></span>
                                    </li>
                                    <?php
                                    if($carerDetails->user_details->age_privacy!=1){
                                    $dateString=$carerDetails->user_details->dob;
                                    $age = round((time()-strtotime($dateString))/(3600*24*365.25))
                                    ?>
                                    <li class="clearfix">
                                        <span class="col-md-6 col-sm-6 col-xs-5 left-span"><i class="fa fa-user" aria-hidden="true"></i>Age</span>
                                        <span class="col-md-6 col-sm-6 col-xs-7 right-span"><?=$age.' year(s)'; ?></span>
                                    </li>
                                    <?php } ?>
                                    <li class="clearfix">
                                        <span class="col-md-6 col-sm-6 col-xs-5 left-span"><i class="fa fa-location-arrow" aria-hidden="true"></i>Location</span>
                                        <span class="col-md-6 col-sm-6 col-xs-7 right-span"><?= (isset($carerDetails->user_details) && $carerDetails->user_details->suburb != '') ? $carerDetails->user_details->suburb . ', ' : '' ?><?= (isset($carerDetails->user_details) && $carerDetails->user_details->zipcode != '') ? $carerDetails->user_details->zipcode : '' ?></span>
                                    </li>
                                     
                                    <li class="text-center">
                                        <?php
                                        if ($carerDetails->is_looking_found == 0) {
                                            ?>
                                            <span class="grn-text-55">
                                                Currently available for caring roles 
                                            </span>
                                        <?php } ?>
                                    </li>
                                </ul>
                                        ...
                                        <ul>
                                            <li>
                                                ...
                                                <input type="hidden" name="user_name" value="<?php echo $session['user_name'];?>" id="">
                                                 <input type="hidden" name="cid" value="<?php echo $carerDetails->user_id;?>" id="">
                                                <input type="hidden" name="cname" value="<?php echo $carerDetails->user_details->first_name;?>" id=""> 
                                                <input type="hidden" name="profile_pic" value="<?php echo $profile_pic;?>" id="">
                                                <a href="<?= Yii::$app->urlManager->createAbsoluteUrl(["joblog/index", "car_id" => base64_encode($carerDetails->user_id)]) ?>" class="no-decor homepage-button booking-link"><span>Log A Job</span></a>
                                            </li>
                                            <li>
                                            ...
                                            <?php  
                                                ...
                                                <li>
                                               <a href="<?= Yii::$app->urlManager->createAbsoluteUrl(["joblog/chatcheck", "car_id" => base64_encode($carerDetails->user_id)]) ?>" onclick="" class="style-btn blue-btn"><span>Message</span></a>
                                            </li>
                                                <?php
                                                }
                                                ?>
                        ...
                        <div class="bottom-box">
                            <div class="box-step">
                                <h3>Type of care available for :</h3>
                            ...
                            <div class="box-step">
                                <h3>Type of caring experience :</h3>
                            ...
                            <div class="box-step">
                                ...
                                <ul>
                                    <li><?= $this->context->carerKnownLanguages($carerDetails->user_id) ?></li>
                                </ul>
                            </div>
                            <div class="box-step">
                                <h3>Available for other duties :</h3>
                            ...
                            <div class="box-step">
                                <ul class="">
                                    <?= ($carerDetails->user_details->id_proofimage != "") ? "<li style='font-size:14px!important'><i class='fa fa-check' aria-hidden='true'></i> Drivers license</li>" : "" ?>
                                    <?= ($carerDetails->parent_status == 1) ? "<li style='font-size:14px!important'><i class='fa fa-check' aria-hidden='true'></i> I am a parent</li>" : "" ?>
                                    <?= ($carerDetails->take_children==1) ? "<li style='font-size:14px!important'><i class='fa fa-check' aria-hidden='true'></i> I would like to take my own children with me to jobs</li>" : "" ?>
                                </ul>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="left-part">
                                        ...
                                        <p>
                                            <?= ($carerDetails->description != '') ? $carerDetails->description : 'Not Given' ?>
                                        </p>
                                    </div>  
                                </div>
                                <div class="col-sm-6">
                                    <div class="right-prt">
                                        <div class="availability blog-box-outer">
                                            <!--<h1 class="prof-heading">Carer Availability <img src="<?= Yii::$app->request->baseUrl; ?>/frontend/images/availability.png" alt="" class="img-responsive"></h1>-->
                                            <h1 class="prof-heading">Carer Availability <i class="fa fa-calendar" aria-hidden="true"></i></h1>
                                                ...
                                                <table class="table">
                                                    <tbody>
                                                        <?php foreach ($day_master as $v) : ?>
                                                            <tr>
                                                                <td><?= $v->name ?></td>
                                                                <td class="text-center"><?= $this->context->getCarerAvailableTime($carerDetails->user_id, $v->id) ?></td>
                                                            </tr>
                                                        <?php endforeach; ?>
                                                    </tbody>
                                                </table>
                                    ...
                                    <div class="scroll-div">
                                        <div class="reviews-short-dtls">
                                            <div class="col-md-2 col-sm-2 no-padding">
                                                <div class="auth-img">
                                                    <a href="javascript:;"><img src="<?= Yii::$app->request->baseUrl; ?>/frontend/images/details-person.jpg" alt="" class="img-responsive"></a>
                                                </div>
                                            </div>
...
<div class="chatbox" id="chatbox">
    <span class="chat-text"><?php echo $carerDetails->user_details->display_name; ?></span>
...
<script>
    function getProfile(id){
        ajaxindicatorstart();
    var url = full_path + "search/getprofileajax";
    $.ajax({
        url: url,
        type: "POST",
        data: {id:id},

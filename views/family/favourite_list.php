                        ...
                        <div class="col-md-9 col-sm-8 padding-lt-rt">
                            <div class="right-part">
                                ...
                                <div class="bottom-part">
                                    <div class="clearfix">
                                        <h1 class="mn-heading">Favourite Carers</h1>
                                        ...
                                        <div class="btm-btm-bx text-center">
                                            <a href="javascript:;" class="btn btn-all" style="display:none;" id="load_btn" onclick="myFavList('family');">Load More</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
